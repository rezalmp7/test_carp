        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('/') }}/employee">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="div" class="form-control" id="inputDiv" aria-describedby="divHelp">
                </div>
                <div class="mb-3">
                    <label for="inputBranch" class="form-label">Branch</label>
                    <input type="text" name="branch" class="form-control" id="inputBranch" aria-describedby="branchHelp">
                </div>
